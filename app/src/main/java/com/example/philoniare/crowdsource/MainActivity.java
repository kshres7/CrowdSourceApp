package com.example.philoniare.crowdsource;
...
public class MainActivity extends AppCompatActivity
    ...
    Button _startButton;
    public static final String BASE_URL = "http://ec2-54-166-170-251.compute-1.amazonaws.com:8080/api";
    ...
    private Boolean getWantIntent() {
        int id = this._radioGroup.getCheckedRadioButtonId();
        //return id == R.id.dataShortIntentRadioButton || id == R.id.micIntentRadioButton;
        return true;
    }
...
//        this.ShowMenu(true);
    ...
    public void onFinalResponseReceived(final RecognitionResult response) {
        ...
        if (!isFinalDicationMessage) {
            ...
            for (int i = 0; i < response.Results.length; i++) {
                ...
                registerEventOnApi(response.Results[i].DisplayText, this);
            }
    ...
    public void registerEventOnApi(final String soundResponse, final Context context) {
        RequestQueue queue = Volley.newRequestQueue(this);
        String url = BASE_URL + "/events/register-event";
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("voiceInput", soundResponse);
                return params;
            }
        };
